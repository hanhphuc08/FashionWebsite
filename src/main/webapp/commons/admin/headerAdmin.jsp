                  ...
                  <use xlink:href="#search-1"> </use>
					...
					<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated"
						...
						<div class="notification-list">
							...
							<a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/admin/manageOrders">
								<i class="fas fa-comment-alt text-primary"></i>
								<div class="ms-2">
									<p class="mb-0">Bạn có một tin nhắn mới.</p>
									<small class="text-muted">5 phút trước</small>
								</div>
							</a> <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/admin/manageOrders">
