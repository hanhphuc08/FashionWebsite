      ...
      <div class="container py-6">
        ...
        <div class="row align-items-md-stretch">
          <div class="col-lg-4 d-flex align-items-lg-stretch position-relative">
            <div class="d-flex align-items-center text-white border-0 w-100 py-6 py-lg-4 text-center mb-4 mb-lg-0" style="background: center center url(https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/photo/rahul-anil-214671-unsplash.jpg) no-repeat; background-size: cover;">
           <a class="tile-link" href="${pageContext.request.contextPath}/categories?categoryCode=QSTM"> </a>
              <div class="w-100">
          ...
          <div class="col-lg-8">
            ...
            <a class="tile-link" href="${pageContext.request.contextPath}/categories?categoryCode=JKD"> </a>
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <a class="tile-link" href="${pageContext.request.contextPath}/categories?categoryCode=APL"> </a>
                  <div class="card-img-overlay d-flex align-items-center">
              ...
              <div class="col-lg-4">
                <div class="card position-relative dark-overlay text-white border-0 mb-lg-0 mb-4"><img class="card-img" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/photo/matese-fields-233175-unsplash.jpg" alt="Card image">
                 <a class="tile-link" href="${pageContext.request.contextPath}/categories?categoryCode=ASMTN"> </a>
                  <div class="card-img-overlay d-flex align-items-center">
                    <div class="text-center w-100 overlay-content">
              ...
              <div class="col-lg-4">
                ...
                <a class="tile-link" href="${pageContext.request.contextPath}/categories?categoryCode=JKT"> </a>
                  <div class="card-img-overlay d-flex align-items-center">
                    <div class="text-center w-100">
            ...
            <div class="product">
              <div class="product-image"><img class="img-fluid" src="${product8.image }" alt="${product8.productName }"/>
                ...
                <a class="product-hover-overlay-link" 
                	href="${pageContext.request.contextPath}/categoryDetail?productCode=${product8.productCode}"></a>
                  <div class="product-hover-overlay-buttons">
                  	<a class="btn btn-dark btn-buy" 
                  	href="${pageContext.request.contextPath}/categoryDetail?productCode=${product8.productCode}"><i class="fa-search fa"></i><span class="btn-buy-label ms-2">Xem</span></a>
                  </div>
                </div>
              </div>
              <div class="py-2">
                <p class="text-muted text-sm mb-1">${product8.typeCategoryName }</p>
                <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="${pageContext.request.contextPath}/categoryDetail">
