...
<header class="header">
        ...
        <div class="container-fluid">  
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/about">Giới thiệu</a>
              </li>
    ...
    <div class="search-area d-flex align-items-center justify-content-center">
        ...
        <form class="search-area-form" action="${pageContext.request.contextPath}/user/categories" method="GET" onsubmit="return cleanForm();">
