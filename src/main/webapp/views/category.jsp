        ...
        <div class="row">
          ...
          <div class="products-grid col-xl-9 col-lg-8 order-lg-2">
            ...
            <nav class="d-flex justify-content-center mb-5 mt-3" aria-label="page navigation">
              <ul class="pagination">
                <li class="page-item"><a class="page-link" href="#" aria-label="Previous"><span aria-hidden="true">Trước</span><span class="sr-only">Previous</span></a></li>
                <li class="page-item active"><a class="page-link" href="#">1       </a></li>
                <li class="page-item"><a class="page-link" href="#">2       </a></li>
                <li class="page-item"><a class="page-link" href="#">3       </a></li>
                <li class="page-item"><a class="page-link" href="#">4       </a></li>
                <li class="page-item"><a class="page-link" href="#">5 </a></li>
                <li class="page-item"><a class="page-link" href="#" aria-label="Next"><span aria-hidden="true">Tiếp</span><span class="sr-only">Next     </span></a></li>
              </ul>
            </nav>
          </div>
          <!-- / Grid End-->
          ...
          <div class="sidebar col-xl-3 col-lg-4 pr-xl-5 order-lg-1">
            <div class="sidebar-block px-3 px-lg-0"><a class="d-lg-none block-toggler" data-bs-toggle="collapse" href="#categoriesMenu" aria-expanded="false" aria-controls="categoriesMenu">Product Categories</a>
              <div class="expand-lg collapse" id="categoriesMenu">
                <div class="nav nav-pills flex-column mt-4 mt-lg-0"> <a class="nav-link d-flex justify-content-between mb-2 " href="#"><span>Áo khoác / Jacket</span><span class="sidebar-badge"> 120</span></a>
                  <div class="nav nav-pills flex-column ms-3"><a class="nav-link mb-2" href="#">Áo Hoodie / Sweater</a><a class="nav-link mb-2" href="#">Áo Len / Cardigan</a><a class="nav-link mb-2" href="#">Áo Gió</a><a class="nav-link mb-2" href="#">Áo khoác không tay / Gilê</a>
                  </div><a class="nav-link d-flex justify-content-between mb-2 active" href="#"><span>Quần</span><span class="sidebar-badge"> 55</span></a>
                  <div class="nav nav-pills flex-column ms-3"><a class="nav-link mb-2" href="#">Quần Ngắn</a><a class="nav-link mb-2" href="#">Quần Dài</a><a class="nav-link mb-2" href="#">Quần Jogger</a>
                  </div><a class="nav-link d-flex justify-content-between mb-2 " href="#"><span>Áo</span><span class="sidebar-badge"> 80</span></a>
                  <div class="nav nav-pills flex-column ms-3"><a class="nav-link mb-2" href="#">Áo thun</a><a class="nav-link mb-2" href="#">Áo dây</a><a class="nav-link mb-2" href="#">Áo Bomber</a><a class="nav-link mb-2" href="#">Áo Blazer</a>
                  </div>
                </div>
              </div>
            </div>
