            ...
            <div class="row">
                ...
                <div class="align-items-start col-lg-6 col-xl-5 ps-lg-5 mb-5 order-1 order-lg-2">
                    <div>
                        ...
                        <form action="${pageContext.request.contextPath}/admin/categoryDetail" method = "POST">
            ...
            <div class="col-lg-2 col-md-4 col-6">
              <div class="product">
                <div class="product-image">
                  ...
                  <div class="product-hover-overlay"><a class="product-hover-overlay-link" href="${pageContext.request.contextPath}/admin/categoryDetail?productCode=${similarProduct.productCode}"></a>
                    <div class="product-hover-overlay-buttons"><a class="btn btn-dark btn-buy" href="${pageContext.request.contextPath}/admin/categoryDetail?productCode=${similarProduct.productCode}"><i class="fa-search fa"></i><span class="btn-buy-label ms-2">Xem</span></a>
                    </div>
                  </div>
                </div>
                <div class="py-2">
                  ...
                  <h3 class="h6 text-uppercase mb-1">
                                <a class="text-dark" href="${pageContext.request.contextPath}/admin/categoryDetail?productCode=${similarProduct.productCode}">
