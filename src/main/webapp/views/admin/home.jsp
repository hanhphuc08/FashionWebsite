  ...
  <body>
    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-sticky navbar-airy navbar-light bg-white bg-fixed-white">
        <div class="container-fluid">  
          <!-- Navbar Header  --><a class="navbar-brand" href="${pageContext.request.contextPath}/admin/home"><svg class="navbar-brand-svg" viewBox="0 0 231 77" width="231" height="77" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!--  Begin Slider -->
	<%@ include file="/commons/admin/sliders.jsp" %>;
	<!-- End Slider -->
    <!--  Begin Brands -->
